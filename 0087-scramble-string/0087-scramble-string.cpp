...
public:
    ...
    int func(string &s1,string &s2,int l1,int r1,int l2,int r2){
        ...
        for(int i=l1;i<r1;i++){
            ...
            if(func(s1,s2,l1,i,l2,l2+len1-1) && func(s1,s2,i+1,r1,r2-len2+1,r2)) return dp[l1][r1][l2] = 1;
            
            if(func(s1,s2,l1,i,r2-len1+1,r2) && func(s1,s2,i+1,r1,l2,l2+len2-1)) return dp[l1][r1][l2] = 1;
